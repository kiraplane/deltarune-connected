...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/deltarune-connected/media/official-1.png',
      logoLight: '/logo.png',
      logoDark: '/logo.png',
    },
    social: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Deltarune Connected Wiki <hello@deltarune-connected.wiki>',
    supportEmail: 'hello@deltarune-connected.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
