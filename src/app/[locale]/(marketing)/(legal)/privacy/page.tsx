...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Privacy Policy | Deltarune Connected Wiki',
    description:
      'Privacy policy for the independent Deltarune Connected Wiki and Roblox guide site.',
    locale,
    pathname: '/privacy',
  });
}
    ...
    <div className="bg-[#0F1117] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Deltarune Connected Wiki is an independent Roblox guide site. We do
          not require accounts for browsing character notes, current guides,
          platform help, code status, official links, or safety pages.
        </p>
        <p className="leading-8 text-[#CBD5E1]">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Privacy questions can be sent to hello@deltarune-connected.wiki.
        </p>
      </Container>
    </div>
  );
