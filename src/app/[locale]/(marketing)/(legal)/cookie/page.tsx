...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Deltarune Connected Wiki',
    description:
      'How Deltarune Connected Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#0F1117] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Deltarune Connected Wiki uses essential cookies and similar
