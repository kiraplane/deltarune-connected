...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/download\/?$/, target: '/play' },
  { pattern: /^\/roblox\/?$/, target: '/play' },
  { pattern: /^\/character\/?$/, target: '/characters' },
  { pattern: /^\/deltarune-connected-codes?\/?$/, target: '/codes' },
  {
    pattern: /^\/roaring-knight\/?$/,
    target: '/guides/roaring-knight',
  },
  {
    pattern: /^\/mobile\/?$/,
    target: '/guides/mobile-and-console',
  },
  {
    pattern: /^\/console\/?$/,
    target: '/guides/console-graphics-fix',
  },
];
